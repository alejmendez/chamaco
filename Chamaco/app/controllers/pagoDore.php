...
class pago extends control_base{
	...
	public function consulta(){
		$orden = $this->db->seleccionarArray('orden' . $this->stablas, 'orden' . $this->stablas.'.*, ubicacion.nombre as ubicacion_venta', array(
	...
	public function reportez(){
		...
		$this->cerrarTerminal();
		$this->salida(array('s' => 's', 'msj' => 'Reporte Z Generado, Terminales Cerrados'));
	}
