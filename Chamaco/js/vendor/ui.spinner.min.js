...
$.widget('ui.spinner', {
	...
	_createButtons: function(input) {
		...
		var self = this,
			...
			wrapper = self.wrapper = input.css({ width: (self.oWidth = (box ? input.width() : input.outerWidth(false))) - buttonWidth, 
		...
		buttons.css({ width: buttonWidth - (box ? buttons.outerWidth(false) - buttons.width() : 0), height: height/2 - (box ? buttons.outerHeight(false) - buttons.height() : 0) });
		upButton = buttons[0];
